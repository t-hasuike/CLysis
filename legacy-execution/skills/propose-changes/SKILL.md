...
|------|-------------|-------------------|---------|
| Impact analysis report | Output file path from /impact-analysis | Required | `reports/impact_reports/add_feature.md` |
...
|------|--------|-------------|
| Change proposal | Diff format + reason, impact scope, test strategy | `reports/proposals/{feature}_{phase}.md` |
